...
import 'package:app_fluxolivrep/src/pages/admin_users_page.dart';
...
import 'package:app_fluxolivrep/src/pages/user_page_test.dart';
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/admin': (_) => AdminPage(),
          '/useradmin': (_) => AdminUsersPage(),
          '/usertest': (_) => AdminUsersTestPage(),
        },
      ),
    );
  }
